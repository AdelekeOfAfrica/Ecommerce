                ...
                <div class = "panel panel-default">
                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent = "updateProduct">
                        ...
                        <div class="form-group">
                            ...
                            <div class= "col-md-4">
                                <input type="file"  class= "input-file"  placeholder="kindly select file"  wire:model="newimage"/>
                                @if($newimage)
                        ...
                        <div class="form-group">
                            ...
                            <div class= "col-md-4">
                                <input type="file"  class= "input-file"  placeholder="kindly select file"  wire:model="newimages" multiple/>
                                @if($newimages)
                        ...
                        <div class="form-group">
                        <button type="submit"  class= "btn btn-danger" style="position:absolute; left:500px;"> Update Product</button>
                        </div>
                    </form>
                    </div>
                </div>
