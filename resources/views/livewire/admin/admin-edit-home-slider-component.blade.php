...
<div>
    ...
    <div class = "row">
        ...
        <div class = "col-md-6">
            <a href = "{{route('admin.homeslider')}}" class="btn btn-danger pull-right"> All Image Slide </a>
        </div>
    </div>
    </div>
    ...
    <div class="form-group">
        <button type="submit"  class= "btn btn-danger" style="position:absolute; left:500px;"> Update Slide</button>
    </div>
</div>
