<main id="main">
		<div class="container">
			...
			<!--On Sale-->
			@if($sproducts->count() > 0 && $sales->status == 1 && $sales->sales_date > carbon\Carbon::now())
				<div class="wrap-show-advance-info-box style-1 has-countdown">
					<h3 class="title-box">On Sale</h3>
					<div class="wrap-countdown mercado-countdown" data-expire="{{Carbon\Carbon::parse($sales->sales_date)->format('Y/m/d h:m:s')}}"></div>
						...
						@foreach($sproducts as $sproduct)
							<div class="product product-style-2 equal-elem ">
								...
								<div class="product-info">
									...
									<div class="wrap-price"><sins><p class="product-price">${{$sproduct->sale_price}}</p></ins><del><p class="product-price">${{$sproduct->regular_price}}</span></div>
								</div>
							</div>
						@endforeach
					</div>
                                    ...
                                    @foreach($latestproducts as $lproduct)
										<div class="product product-style-2 equal-elem ">
											...
											<div class="product-info">
												...
												<div class="wrap-price"><ins><p class="product-price">${{$lproduct->regular_price}}</p></ins> </div>
											</div>
										</div>
                                    @endforeach
								</div>
