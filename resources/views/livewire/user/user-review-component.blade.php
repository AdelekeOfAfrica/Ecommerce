            ...
            <div id="review_form_wrapper">
                ...
                <div id="review_form">
                    ...
                    <div id="respond" class="comment-respond"> 
                        <form wire:submit="addReview" id="commentform" class="comment-form" novalidate="">
                            <div class="comment-form-rating">
                                ...
                                <p class="stars">
                                    ...
                                    @error('rating')<span class="text-ddanger">{{$message}}</span>@enderror
                                </p>
                            </div>
                            <p class="comment-form-comment">
                                <label for="comment">Your review <span class="required">*</span>
                                </label>
                                <textarea id="comment" name="comment" cols="45" rows="8" class="form-control" wire:model="comment"></textarea>
                                @error('comment')<span class="text-ddanger">{{$message}}</span>@enderror
                            </p>
                            <p class="form-submit">
