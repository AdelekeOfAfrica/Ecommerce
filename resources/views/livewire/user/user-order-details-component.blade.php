    ...
    <div class = "container" style = "padding:30px 0;">
        <div class = "row">
            ...
            @if(Session::has('cancel_message'))
                <div class="alert alert-success" role="alert">{{Session::get('cancel_message')}}</div>
                @endif
               <div class="panel panel-default">
                    <div class = "panel-heading">
                        <div class = "row">
                            ...
                            <div class="col-md-6">
                                <a href="{{route('user.orders')}}" class="btn  btn-sm  pull-right btn-danger">My Order</a>
                        ...
                        <ul class="products-cart">
                            @foreach($order->orderItems as $item)
                                <li class="pr-cart-item">
                                    ...
                                    <div class="price-field sub-total"><p class="price"><a href="{{route('user.review',['order_item_id'=>$item->id])}}" class="btn btn-danger ">Write Review</a></div>
                                    @endif
                                </li>
                            @endforeach
                        </ul>
